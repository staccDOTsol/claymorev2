...
```
env ANCHOR_WALLET=~/.config/solana/id.json ANCHOR_PROVIDER_URL=https://solana--devnet.datahub.figment.io/apikey/24c64e276fc5db6ff73da2f59bac40f2 yarn run bootstrap
```
